...
<body class="flex flex-col min-h-screen bg-gray-50">
    ...
    <header class="bg-gray-800 p-3 md:p-4 flex justify-between items-center fixed w-full top-0 z-50 shadow-lg">
        <div class="flex items-center">
            <div class="relative">
                <img src="/assets/img/poto enhai.png" alt="Logo" class="h-10 md:h-14 mr-2 md:mr-4 w-10 md:w-14 transition-transform duration-300 hover:scale-110">
    ...
    <footer class="bg-gray-800 text-center py-12">
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-left">
                ...
                <div>
                    <h3 class="text-white font-bold text-lg mb-4">Alamat</h3>
                    <ul class="space-y-2">
                        <li><a href="{{url('about')}}" class="text-gray-400 hover:text-white transition duration-300"> D’Esta Square No. 10 Jalan Pakuan No. 02, Baranangsiang,
                         Bogor, Jawa Barat 16143, Indonesia</a></li>

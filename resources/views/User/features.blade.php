    ...
    <main class="flex-grow pt-20 md:pt-24">
        ...
        <section class="py-12 md:py-20  bg-gradient-to-br from-gray-800 to-gray-900 text-white">
            <div class="container mx-auto px-4 text-center">
                ...
                <p class="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">Solusi inventaris terbaik untuk institusi pekerjaan dengan berbagai fitur canggih untuk memudahkan pengelolaan aset</p>
            </div>
        </section>
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col md:flex-row items-center mb-16">
                    <div class="md:w-1/2 mb-8 md:mb-0">
                        ...
                        <p class="text-gray-600 mb-8 text-lg">Kelola seluruh aset perusahaan dari satu platform dengan sistem kategorisasi dan pelacakan yang komprehensif.</p>
                        <div class="space-y-4">
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col md:flex-row-reverse items-center mb-16">
                    <div class="md:w-1/2 mb-8 md:mb-0 md:pl-12">
                        ...
                        <p class="text-gray-600 mb-8 text-lg">Dapatkan insight tentang inventaris perusahaan dengan laporan real-time dan dashboard yang informatif.</p>
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <div class="bg-gray-100 p-2 rounded-full mr-4">
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col md:flex-row-reverse items-center mb-16">
                    <div class="md:w-1/2 mb-8 md:mb-0 md:pl-12">
                        ...
                        <p class="text-gray-600 mb-8 text-lg">Lindungi data inventaris perusahaan dengan fitur keamanan canggih dan standar industri terkini.</p>
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <div class="bg-gray-100 p-2 rounded-full mr-4">
            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col md:flex-row items-center mb-16">
                    <div class="md:w-1/2 mb-8 md:mb-0">
                        ...
                        <p class="text-gray-600 mb-8 text-lg">Hubungkan sistem inventaris dengan aplikasi dan platform lain yang digunakan di perusahaan Anda.</p>
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <div class="bg-gray-100 p-2 rounded-full mr-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">Gunakan API kami untuk menghubungkan dengan sistem manajemen perusahaan lainnya.</p>
                                </div>
                            </div>
                            <div class="flex items-start">
                                <div class="bg-gray-100 p-2 rounded-full mr-4">
        ...
        <section class="py-16 bg-white">
            <div class="container mx-auto px-4">
                ...
                <p class="text-center text-gray-600 mb-12 max-w-2xl mx-auto">Kami terus mengembangkan fitur baru untuk memenuhi kebutuhan pengelolaan inventaris perusahaan Anda</p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div class="feature-card bg-white rounded-xl p-6 shadow-md">
                        ...
                        <p class="text-gray-600">Berbagai template dokumen siap pakai untuk kebutuhan administrasi inventaris perusahaan.</p>
                    </div>
...
<div class="px-6 pb-4">
    <p class="text-gray-600">Kami menyediakan versi dasar yang dapat digunakan secara gratis dengan fitur terbatas. Untuk fitur lengkap, tersedia paket berlangganan dengan harga yang terjangkau dan sesuai kebutuhan institusi pekerjaan.</p>
</div>
                    </div>
    ...
    <div class="container mx-auto px-4 text-center pb-12">
                <h2 class="text-3xl md:text-4xl font-bold mb-6">Siap Untuk Mengoptimalkan Inventaris Perusahaan Anda?</h2>
                <p class="text-gray-300 mb-8 max-w-2xl mx-auto">Mulai gunakan sistem Inventaris Barang sekarang dan rasakan kemudahan mengelola aset perusahaan Anda secara efisien.</p>
        ...
        <div class="container mx-auto px-4">
            <div class="flex flex-wrap justify-between">
                ...
                <div class="w-full md:w-1/4 mb-8 md:mb-0">
                    ...
                    <p class="text-gray-400 mb-4">Solusi manajemen inventaris terbaik untuk institusi pekerjaan di Indonesia.</p>
                ...
                <div class="w-full md:w-1/4">
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-400">D'Esta Square No. 10, Jl. Pakuan No.02, RT.01/RW.11, Baranangsiang, Bogor Timur, Bogor City, West Java 16143</span>
                        </li>
                        <li class="flex items-center">
                            <i class="fas fa-phone-alt mr-3 text-gray-400"></i>
                            <span class="text-gray-400">(0251) 7561016</span>
                        </li>
                        <li class="flex items-center">
                            <i class="fas fa-envelope mr-3 text-gray-400"></i>
                            <span class="text-gray-400"> info@enhaiimandiri.com</span>
                        </li>
                    </ul>
                </div>
            </div>

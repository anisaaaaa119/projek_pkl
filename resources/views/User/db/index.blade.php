        ...
        <table class="min-w-full bg-white">
            <thead>
                <tr class="bg-green-600 text-white">
                    ...
                    <th class="py-4 px-6 text-center font-semibold">Lokasi</th>

                    ...
                    <div class="space-y-4">
                        <div class="contact-info-item flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">D'Esta Square No. 10, Jl. Pakuan No.02, RT.01/RW.11, Baranangsiang, Bogor Timur,
                        ...
                        <div class="contact-info-item flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">info@enhaiimandiri.com</p>
                            </div>
                        </div>
                        ...
                        <div class="contact-info-item flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">+62 251-756-1016</p>
                            </div>
                        </div>
                        ...
                        <div class="contact-info-item flex items-center space-x-4">
                            ...
                            <div>
                                ...
                                <p class="text-gray-600">Senin - Jumat: 08:00 - 16:30</p>
                                <p class="text-gray-600">Sabtu - Minggu: Libur</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    ...
                    <div class="bg-white rounded-2xl p-8 shadow-lg transform hover:-translate-y-2 transition-all duration-300 border border-gray-100 hover:border-gray-500">
                        ...
                        <div class="text-center">
                            ...
                            <h3 class="text-2xl font-bold text-gray-800 mb-2">--</h3>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8 text-left">
                <div>
                    ...
                    <p class="text-gray-400 mb-4">Platform manajemen inventaris barang modern untuk Peruasahaan-Perusahaan di Indonesia.</p>
                ...
                <div>
                    ...
                    <p class="text-gray-400 mb-2"><i class="fas fa-map-marker-alt mr-2"></i> D’Esta Square No. 10, Jalan Pakuan No. 02, Baranangsiang, Bogor,
                         Jawa Barat 16143, Indonesia</p>
                    <p class="text-gray-400 mb-2"><i class="fas fa-phone mr-2"></i> +62 251-756-1016 </p>

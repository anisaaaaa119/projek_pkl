    ...
    <header class="bg-gray-800 shadow-lg p-4 flex justify-between items-center fixed w-full top-0 z-50">
        <div class="flex items-center">
            ...
            <div>
                ...
                <span class="hidden md:block text-gray-300 text-xs">Sistem Management Perusahaan</span>
            </div>
        </div>
        <div class="space-x-4">
        ...
        <div class="container mx-auto py-12">
            ...
            <div class="text-center mb-16 animate__animated animate__fadeIn">
                ...
                <p class="text-xl text-gray-600 max-w-3xl mx-auto">
                    Solusi Modern untuk Manajemen Inventaris Perusahaan yang Efisien
                </p>
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 mb-16">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 card-hover animate__animated animate__fadeInLeft">
                    ...
                    <p class="text-gray-700 leading-relaxed mb-6">
                        Aplikasi Inventaris Barang adalah sistem manajemen berbasis web yang dirancang khusus untuk memudahkan pengelolaan dan pemantauan perusahaan. Aplikasi ini mengintegrasikan teknologi modern untuk menciptakan sistem pencatatan yang efisien, akurat, dan mudah diakses.
                    </p>
                    <p class="text-gray-700 leading-relaxed">
                        Dengan antarmuka yang intuitif dan fitur-fitur komprehensif, aplikasi ini memungkinkan staff perusahaan untuk melacak, mengelola, dan memantau inventaris perusaahaan secara real-time, memastikan pengelolaan aset yang optimal dan transparan.
                    </p>
                </div>
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 card-hover animate__animated animate__fadeInRight">
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-start">
                            ...
                            <span class="text-gray-700">Pengawasan aset perusahan yang lebih efektif dan terstruktur</span>
                        </li>
                        <li class="flex items-start">
                            <div class="flex-shrink-0 w-6 h-6 rounded-full bg-green-100 flex items-center justify-center mr-3">
                                <i class="fas fa-check text-green-600 text-sm"></i>
                ...
                <div class="grid md:grid-cols-3 gap-8">
                    <div class="p-6 bg-gray-50 rounded-xl card-hover">
                        ...
                        <p class="text-gray-600 text-center">
                            Mengoptimalkan proses manajemen inventaris untuk meningkatkan efisiensi operasional perusahaan
                        </p>
                    </div>
    ...
    <footer class="bg-gray-800 text-center py-6 mt-12">
        <div class="container mx-auto px-4">
            ...
            <div class="border-t border-gray-700 pt-6">
                <p class="text-gray-300 mb-2">© 2025 Inventaris Barang. All rights reserved.</p>
